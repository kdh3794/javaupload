...
public class BoardController {
    ...
    public String articlewrite(Model model
                ...
                //1. tb_bbs_article table insert. inserted pk 값을 변환 받는다.
                //2. client의 파일을 서버로 복사.
                //3. tb_bbs_attachfile 테이블에 insert
                
              // tb_bbs_article table insert. inserted pk 값을 변환 받는다.
                 ...
                 if(!upload.getOriginalFilename().isEmpty()) {
                     ...
                     String newFile  = WebConstants.UPLOAD_PATH + tempName; // c:/upload/20180124(현재날짜 현재 시간)
