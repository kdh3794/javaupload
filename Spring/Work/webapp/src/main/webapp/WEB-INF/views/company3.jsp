...
<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCIjE95EEaou7VAOu1Mmod_HbvFQguQh7U&callback=initMap"
  ></script>
...
function initialize() {
        var mapLocation = new google.maps.LatLng('37.655557', '127.060504'); // 지도에서 가운데로 위치할 위도와 경도
        var markLocation = new google.maps.LatLng('337.655557', '127.060504'); // 마커가 위치할 위도와 경도
...
//             info: '말풍선 안에 들어갈 내용',
               title: '노원' // 마커에 마우스 포인트를 갖다댔을 때 뜨는 타이틀
        });

        var content = "이곳은 노원이다 <br/> 지하철 타러 가자~"; // 말풍선 안에 들어갈 내용
