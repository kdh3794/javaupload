    ...
    <section id="page1" data-role="page">
        ...
        <div class="content" data-role="content">
            ...
            <div id="main">
                ...
                <!-- 이미지 썸네일 리스트 만들기 -->
                <ul class="n_img_list">
                    <li><a href="#"> <img src="../../resources/images/thumb_main_01x2.png" alt="" />
                     <br> 
                    <span>Instagram  may be testing a flatter, black and  white design</span>
                    </a></li>
                    <li><a href="#"> <img src="../../resources/images/thumb_main_02x2.png" alt="" />
                     <br> 
                    <span>Moustakas scratched for series opener in Cleveland with </span>
                    </a></li>
                    <li><a href="#"> <img src="../../resources/images/thumb_main_03x2.png" alt="" /> 
                    <br> 
            ...
            <!-- 배너 만들기 -->
            <div class="banner">
                <a href="#"> <span class="text"> 모바일 디자인 참
                        쉽죵~~~~</span>
                </a>
            </div>
        </div>
