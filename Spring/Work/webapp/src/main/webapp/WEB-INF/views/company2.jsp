...
function movieDialog(str) {
      //선택한 버튼의 동영상 경로를 불러옴
      $(".viedo.mp4").attr("src", $(str).attr("value"));
      //동영상을 다시 load 함
      $("viedo.mp4").load();
      //load한 동영상을 재생
      document.getElementById("viedo").play();
    };
            ...
            <div class="m_cont">
                ...
                <span class="play">
                 <video controls width="100%">
                  ...
                  <source src="viedo.mp4" type="viedo.mp4"/>
                     <!-- HTML5 video요소를 지원하지 않는 브라우저의 경우 플래시 무비를 사용합니다 -->
                  <img src="../../resoureces/images/m1_02_imgx2.png" width="286" height="168"/>
                 </video>
                </span>
            </div>
        </div>
