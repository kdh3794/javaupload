			...
			<div class="navbar-collapse collapse">							
				<div class="menu">
					<ul class="nav nav-tabs" role="tablist">
						<li role="presentation" class="active"><a href="pj_mn10_01">Home</a></li>
			...
			<div class="col-md-8">
				<div class="page-header">
					<div class="blog">
						...
						<img src="../../resources/img/01.jpg" class="img-responsive"alt="" />			
			...
			<div class="col-md-4">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="media">
							<a class="media-left" href="#">
								<img src="../../resources/img/c.jpg" alt="">
							</a>
							<div class="media-body">
								<h4 class="media-heading">Kelly Hidayah</h4>
								<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, 
					...
					<div class="panel-body">
						<div class="media">
							<a class="media-left" href="#">
								<img src="../../resources/img/d.jpg" alt="">
							</a>
							<div class="media-body">
								<h4 class="media-heading">Kelly Hidayah</h4>
								<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, 
			...
			<div class="container">
				<div class="row">
					<div class="col-md-4 f-about">
						<a href="index"><h1><span>e</span>Nno</h1></a>
