...
public class TestUploadFile {
    ...
    public void testInsertUploadFile() throws IOException {
        ...
        MockMultipartFile clientfile = new MockMultipartFile(
                uploadfile.getName(), uploadfile.getName(), "image/png",
                inputFile);
        String UPLOAD_PATH = "C:\\"; // 클라이언트에서 올라온 images.png를 저장할 서버의 폴더 위치
        ...
        if (!clientfile.getOriginalFilename().isEmpty()) {
            ...
            clientfile.transferTo(serverfile); // 파일 카피하는 메서드
