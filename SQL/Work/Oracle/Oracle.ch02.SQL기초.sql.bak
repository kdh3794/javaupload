...
-- oracle에서는 nvl() 함수를 사용해야 한다.
-- @@@@@@@@@@@@@@@@@@@@@@@@


select nv1(1, 0)    from dual;
...
--concat 을 이용하며 'A and B;fㄹ 출력하시오.
select 'A' || 'and' || 'B' from dual;
...
select * from emp order by ename desc, hiredate asc;
...
-- left join 사용
-- oracle 에서는 minus를 사용
select * from GROUP_STAR
minus
select * from SINGLE_ STAR;
